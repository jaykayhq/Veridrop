...
You have Superpowers. This project-level CLAUDE.md extends the global Superpowers methodology with Veridrop-specific context. Follow the global Superpowers workflow (Brainstorm → Plan → TDD → Review), then layer on these project details.
